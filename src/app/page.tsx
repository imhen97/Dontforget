      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        >
          ...
          <div style={{
            ...
            backgroundImage: 'linear-gradient(#e4c1f9 1px, transparent 1px)',
          ...
          <div className="space-y-2.5 mb-5" style={{ position: 'relative', zIndex: 1 }}>
            <button
              ...
              style={{
                ...
                border: '2px solid #3C1E1E', borderRadius: '10px',
            ...
            <button
              ...
              style={{
                ...
                border: '2px solid #e4c1f9', borderRadius: '10px',
                boxShadow: '3px 3px 0px #e4c1f9',
                cursor: 'pointer', opacity: socialLoading ? 0.6 : 1,
                transition: 'all 0.15s', minHeight: 52,
              }}
            >
          ...
          <div className="flex items-center gap-3 mb-5" style={{ position: 'relative', zIndex: 1 }}>
            <div style={{ flex: 1, height: 1, borderBottom: '1.5px dashed #e4c1f9' }} />
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-4" style={{ position: 'relative', zIndex: 1 }}>
            ...
            <button type="submit" disabled={loading} className="btn-primary w-full text-center mt-2">
              {loading ? '처리 중...' : isLogin ? '노트 열기 📖' : '노트 만들기 ✏️'}
            </button>
          </form>
        ...
        <div className="grid grid-cols-3 gap-3 mt-5">
          {[
            ...
            <div key={f.text} style={{
              ...
              border: '2px solid #e4c1f9', borderLeft: '3px solid #ff99c8',
              padding: '10px 8px', textAlign: 'center',
              boxShadow: '2px 2px 0px #e4c1f9',
            }}>
